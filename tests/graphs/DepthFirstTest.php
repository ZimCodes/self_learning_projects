...
use ZimCodes\Self_Learning\DataStructures\Graphs\Depth_First\Graph;
...
class DepthFirstTest extends TestCase{
    ...
    public function testPathResultSize():void{
        $this->assertCount(count(self::$nodes), self::$graph->getPath());
    }
    public function testPathResult():void{
